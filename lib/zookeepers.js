...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            // since our form data will be coming in as strings, and our JSON is storing as a a number, we must convert the query string to a number to perform a comparison. 
